...
namespace AmIReal.KimlikDogrula {
    ...
    public interface KPSPublicSoap {
        ...
        AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : AmIReal.KimlikDogrula.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<AmIReal.KimlikDogrula.KPSPublicSoap>, AmIReal.KimlikDogrula.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponse AmIReal.KimlikDogrula.KPSPublicSoap.TCKimlikNoDogrula(AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest inValue = new AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest();
            inValue.Body = new AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponse retVal = ((AmIReal.KimlikDogrula.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponse> AmIReal.KimlikDogrula.KPSPublicSoap.TCKimlikNoDogrulaAsync(AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest request) {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<AmIReal.KimlikDogrula.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest inValue = new AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequest();
            inValue.Body = new AmIReal.KimlikDogrula.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((AmIReal.KimlikDogrula.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
    }
}
